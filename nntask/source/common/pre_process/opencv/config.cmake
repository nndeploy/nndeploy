...
set(TMP_SOURCE)
set(TMP_OBJECT)
set(TMP_BINARY nntask_common_pre_process_opencv)
...
file(GLOB_RECURSE TMP_SOURCE
  "${ROOT_PATH}/nntask/source/common/pre_process/opencv/*.h"
  "${ROOT_PATH}/nntask/source/common/pre_process/opencv/*.cc"
  )
file(GLOB_RECURSE TMP_TEST_SOURCE
  "${ROOT_PATH}/nntask/source/common/pre_process/opencv/*_test.h"
  "${ROOT_PATH}/nntask/source/common/pre_process/opencv/*_test.cc"
  )
