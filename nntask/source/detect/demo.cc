...
cv::Mat draw_box(cv::Mat &cv_mat, nntask::common::DetectResult &result) {
...
int yolo_main(int argc, char *argv[]) {
  ...
  nntask::detect::YoloTask *task = new nntask::detect::YoloTask(
  ...
  nntask::common::DetectResult result;
