...
set(TMP_SOURCE)
set(TMP_OBJECT)
set(TMP_BINARY nntask_detect_post_process_opencv)
...
file(GLOB_RECURSE TMP_SOURCE
  "${ROOT_PATH}/nntask/source/detect/post_process/opencv/*.h"
  "${ROOT_PATH}/nntask/source/detect/post_process/opencv/*.cc"
  )
file(GLOB_RECURSE TMP_TEST_SOURCE
  "${ROOT_PATH}/nntask/source/detect/post_process/opencv/*_test.h"
  "${ROOT_PATH}/nntask/source/detect/post_process/opencv/*_test.cc"
  )
