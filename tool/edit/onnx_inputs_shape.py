...
def parse_args():
    ...
    parser.add_argument('--dst_model_path', type=str, required=True, help='Path to save the modified ONNX model.')
    parser.add_argument('--input_shapes', type=str, required=True, help='Input shapes in the format "input1:1,3,224,224;input2:1,10".')
    parser.add_argument('--is_infer_shape', action='store_true', help='Whether to infer shapes for the ONNX model.')
...
def write_onnx_input_shape(src_model_path, dst_model_path, input_shapes, is_infer_shape):
    """
    修改 ONNX 模型的输入形状
    ...
    is_infer_shape (bool): 是否推断 ONNX 模型的形状
...
if __name__ == '__main__':
    ...
    write_onnx_input_shape(src_model_path, dst_model_path, input_shapes, args.is_infer_shape)

# resnet
## python3 onnx_inputs_shape.py --src_model_path /home/ascenduserdg01/github/nndeploy/build/resnet50-v1-7.onnx --dst_model_path /home/ascenduserdg01/github/nndeploy/build/resnet50-v1-7.staticshape.onnx --input_shapes data:1,3,224,224
