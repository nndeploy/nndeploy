 ...
 *
 */
class NNDEPLOY_CC_API MaskResult : base::Param {
 public:
  MaskResult() : Param(){};
 ...
 */
class NNDEPLOY_CC_API PerceptionResult : public base::Param {
 public:
 ...
 * models
 */
class NNDEPLOY_CC_API KeyPointDetectionResult : public base::Param {
 public:
   ...
   */
  std::vector<base::Point2f> keypoints_;
  /**
 ...
 */
class NNDEPLOY_CC_API FaceDetectionResult : public base::Param {
 public:
   ...
   * location [x,y]
   */
  std::vector<base::Point2f> landmarks_;
  /**
   * @brief
 ...
 */
class NNDEPLOY_CC_API FaceAlignmentResult : public base::Param {
 public:
 ...
 */
class NNDEPLOY_CC_API SegmentationResult : public base::Param {
 public:
 ...
 */
class NNDEPLOY_CC_API FaceRecognitionResult : public base::Param {
 public:
 ...
 */
class NNDEPLOY_CC_API HeadPoseResult : public base::Param {
 public:
...
#endif /* _NNDEPLOY_SOURCE_TASK_RESULTS_H_ */
