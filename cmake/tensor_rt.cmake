...
if (NNDEPLOY_ENABLE_INFERENCE_TENSORRT STREQUAL "ON")
  message(STATUS "NNDEPLOY_ENABLE_INFERENCE_TENSORRT: ${NNDEPLOY_ENABLE_INFERENCE_TENSORRT}")
else()
  include_directories(${NNDEPLOY_ENABLE_INFERENCE_TENSORRT}/include)
  ...
  # endif()
  # set(tmp_path ${NNDEPLOY_ENABLE_INFERENCE_TENSORRT}/lib/x86/Release)
