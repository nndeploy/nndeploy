...
elseif (ENABLE_NNDEPLOY_FFMPEG STREQUAL "ON")
  set(FFMPEG_PATH ${ROOT_PATH}/third_party/ffmpeg/install/)
  ...
  set(AVCODEC_LIBRARIES ${FFMPEG_PATH}/bin/avcodec.lib)
  set(AVFORMAT_LIBRARIES ${FFMPEG_PATH}/bin/avformat.lib)
  set(AVUTIL_LIBRARIES ${FFMPEG_PATH}/bin/avutil.lib)
  set(AVFILTER_LIBRARIES ${FFMPEG_PATH}/bin/avfilter.lib)
  set(AVDEVICE_LIBRARIES ${FFMPEG_PATH}/bin/avdevice.lib)
  set(SWRESAMPLE_LIBRARIES ${FFMPEG_PATH}/bin/swresample.lib)
  set(SWSCALE_LIBRARIES ${FFMPEG_PATH}/bin/swscale.lib)
