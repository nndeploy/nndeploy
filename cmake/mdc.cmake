...
if (ENABLE_NNDEPLOY_INFERENCE_MDC STREQUAL "OFF")
elseif (ENABLE_NNDEPLOY_INFERENCE_MDC STREQUAL "ON")
else()
  include_directories(${ENABLE_NNDEPLOY_INFERENCE_MDC}/include)
  set(LIB_PATH ${ENABLE_NNDEPLOY_INFERENCE_MDC}/lib64/stub)
  set(LIBS "ascendcl")
  foreach(LIB ${LIBS})
  ...
  endforeach()
  if(SYSTEM.Windows)
    set(BIN_PATH ${ENABLE_NNDEPLOY_INFERENCE_MDC}/bin)
