...
file(GLOB TMP_SOURCE
  "${ROOT_PATH}/nndeploy/include/task/pre_process/*.h"
  "${ROOT_PATH}/nndeploy/include/task/pre_process/*.cc"
  )
if(NNDEPLOY_ENABLE_OPENCV)
  file(GLOB TMP_OPENCV_SOURCE
    "${ROOT_PATH}/nndeploy/include/task/pre_process/opencv/*.h"
    "${ROOT_PATH}/nndeploy/include/task/pre_process/opencv/*.cc"
  )
