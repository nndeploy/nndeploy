...
//     NNDEPLOY_RETURN_ON_NEQ(status, base::kStatusCodeOk, "setTimesteps
//     failed!");
...
//     status = Loop::init();
//     NNDEPLOY_RETURN_ON_NEQ(status, base::kStatusCodeOk, "Loop::init
//     failed!");
...
//     this->getEdge("encoder_hidden_states"); device::Tensor
//     *encoder_hidden_states_tensor =
...
//   dag::Graph *text2image_scheduler_unet =
//   createText2ImagesSchedulerUNetGraph(
...
//   // vae
//   dag::Node *vae = graph->createInfer<infer::Infer>("vae",
//   vae_inference_type,
//                                                     latent, output);
