message(STATUS "plugin/matting")

# set
set(PLUGIN_SOURCE)
set(PLUGIN_OBJECT)
set(PLUGIN_BINARY nndeploy_plugin_matting)

# SOURCE
file(GLOB PLUGIN_SOURCE
  "${PLUGIN_ROOT_PATH}/include/nndeploy/matting/*.h"
  "${PLUGIN_ROOT_PATH}/source/nndeploy/matting/*.cc"
)

if(ENABLE_NNDEPLOY_PLUGIN_MATTING_PPMATTING)
  file(GLOB_RECURSE PPMATTING_SOURCE
    "${PLUGIN_ROOT_PATH}/include/nndeploy/matting/pp_matting/*.h"
    "${PLUGIN_ROOT_PATH}/source/nndeploy/matting/pp_matting/*.cc"
  )
  set(PLUGIN_SOURCE ${PLUGIN_SOURCE} ${PPMATTING_SOURCE})
endif()
...
if(SYSTEM_Windows)
  ...
  install(DIRECTORY ${PLUGIN_ROOT_PATH}/include/nndeploy/matting DESTINATION ${NNDEPLOY_INSTALL_INCLUDE_PATH}/nndeploy)
else()
