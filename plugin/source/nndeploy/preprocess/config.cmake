...
set(PLUGIN_SOURCE)
set(PLUGIN_OBJECT)
set(PLUGIN_BINARY nndeploy_plugin_preprocess)

# SOURCE
file(GLOB_RECURSE PLUGIN_SOURCE
  "${PLUGIN_ROOT_PATH}/include/nndeploy/preprocess/*.h"
  "${PLUGIN_ROOT_PATH}/source/nndeploy/preprocess/*.cc"
)
...
if(SYSTEM.Windows)
  ...
  install(DIRECTORY ${PLUGIN_ROOT_PATH}/include/nndeploy/preprocess DESTINATION ${NNDEPLOY_INSTALL_INCLUDE_PATH}/nndeploy)
else()
