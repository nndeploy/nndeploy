message(STATUS "plugin/super_resolution")

# set
set(PLUGIN_SOURCE)
set(PLUGIN_OBJECT)
set(PLUGIN_BINARY nndeploy_plugin_super_resolution)

# SOURCE
file(GLOB PLUGIN_SOURCE
  "${PLUGIN_ROOT_PATH}/include/nndeploy/super_resolution/*.h"
  "${PLUGIN_ROOT_PATH}/source/nndeploy/super_resolution/*.cc"
)
...
if(SYSTEM_Windows)
  ...
  install(DIRECTORY ${PLUGIN_ROOT_PATH}/include/nndeploy/super_resolution DESTINATION ${NNDEPLOY_INSTALL_INCLUDE_PATH}/nndeploy)
else()
