message(STATUS "plugin/feedback")

# set
set(PLUGIN_SOURCE)
set(PLUGIN_OBJECT)
set(PLUGIN_BINARY nndeploy_plugin_feedback)

# SOURCE
file(GLOB PLUGIN_SOURCE
  "${PLUGIN_ROOT_PATH}/include/nndeploy/feedback/*.h"
  "${PLUGIN_ROOT_PATH}/source/nndeploy/feedback/*.cc"
)
...
if(SYSTEM.Windows)
  ...
  install(DIRECTORY ${PLUGIN_ROOT_PATH}/include/nndeploy/feedback DESTINATION ${NNDEPLOY_INSTALL_INCLUDE_PATH}/nndeploy)
else()
