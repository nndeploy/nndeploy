message(STATUS "plugin/loop")

# set
set(PLUGIN_SOURCE)
set(PLUGIN_OBJECT)
set(PLUGIN_BINARY nndeploy_plugin_loop)

# SOURCE
file(GLOB PLUGIN_SOURCE
  "${PLUGIN_ROOT_PATH}/include/nndeploy/loop/*.h"
  "${PLUGIN_ROOT_PATH}/source/nndeploy/loop/*.cc"
)
...
if(SYSTEM.Windows)
  ...
  install(DIRECTORY ${PLUGIN_ROOT_PATH}/include/nndeploy/loop DESTINATION ${NNDEPLOY_INSTALL_INCLUDE_PATH}/nndeploy)
else()
