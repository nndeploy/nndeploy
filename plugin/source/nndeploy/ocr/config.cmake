message(STATUS "plugin/ocr")

# set
set(PLUGIN_SOURCE)
set(PLUGIN_OBJECT)
set(PLUGIN_BINARY nndeploy_plugin_ocr)

# SOURCE
file(GLOB PLUGIN_SOURCE
  "${PLUGIN_ROOT_PATH}/include/nndeploy/ocr/*.h"
  "${PLUGIN_ROOT_PATH}/source/nndeploy/ocr/*.cc"
)
...
if(SYSTEM.Windows)
  ...
  install(DIRECTORY ${PLUGIN_ROOT_PATH}/include/nndeploy/ocr DESTINATION ${NNDEPLOY_INSTALL_INCLUDE_PATH}/nndeploy)
else()
