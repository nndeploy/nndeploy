#include "nndeploy/model/detect/yolo/yolo_multi_conv_output.h"
...
static void generateProposals(const int *anchors, const int* strides, int stride,
                              const int model_w, const int model_h, const int det_len,
...
dag::Graph *createYoloV5MultiConvOutputGraph(const std::string &name,
