...
#ifndef _NNDEPLOY_CODEC_FFMPEG_BATCH_CODEC_H_
#define _NNDEPLOY_CODEC_FFMPEG_BATCH_CODEC_H_
...
class NNDEPLOY_CC_API BatchFFmpegDecode : public dag::CompositeNode {
 public:
  BatchFFmpegDecode(const std::string &name) : dag::CompositeNode(name) {
    key_ = "nndeploy::codec::BatchFFmpegDecode";
    node_type_ = dag::NodeType::kNodeTypeInput;
    this->setOutputTypeInfo<std::vector<cv::Mat>>();
    desc_ =
        "BatchFFmpegDecode node for decoding batches of images/videos using "
        "FFmpeg";
  }
  BatchFFmpegDecode(const std::string &name, std::vector<dag::Edge *> inputs,
...
class NNDEPLOY_CC_API BatchFFmpegEncode : public dag::CompositeNode {
 public:
  BatchFFmpegEncode(const std::string &name) : dag::CompositeNode(name) {
    key_ = "nndeploy::codec::BatchFFmpegEncode";
    node_type_ = dag::NodeType::kNodeTypeOutput;
    this->setInputTypeInfo<std::vector<cv::Mat>>();
    desc_ =
        "BatchFFmpegEncode node for encoding batches of images/videos using "
        "FFmpeg";
  }
  BatchFFmpegEncode(const std::string &name, std::vector<dag::Edge *> inputs,
                    std::vector<dag::Edge *> outputs)
      : dag::CompositeNode(name, inputs, outputs) {
    key_ = "nndeploy::codec::BatchFFmpegEncode";
    node_type_ = dag::NodeType::kNodeTypeOutput;
...
#endif /* _NNDEPLOY_CODEC_FFMPEG_BATCH_CODEC_H_ */
