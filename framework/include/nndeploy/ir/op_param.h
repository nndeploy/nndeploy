...
class NNDEPLOY_CC_API RotateEmbeddingParam : public OpParam {
 public:
  RotateEmbeddingParam() : OpParam() {};
  virtual ~RotateEmbeddingParam() {};

  PARAM_COPY(RotateEmbeddingParam)
  PARAM_COPY_TO(RotateEmbeddingParam)
