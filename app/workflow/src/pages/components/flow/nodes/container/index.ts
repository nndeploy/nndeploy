...
import { ContainerFormRender } from './loop-form-render';
...
let index = 0;
export const ContainerNodeRegistry: FlowNodeRegistry = {
  type: WorkflowNodeType.Container,
  info: {
    icon: iconLoop,
    description:
