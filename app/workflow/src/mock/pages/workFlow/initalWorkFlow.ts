...
export const businessContents: IBusinessNode[] = [
  {
    ...
    outputs_: [
      {
        name_: "post_output_0_Param",
        type_: "nndeploy._nndeploy_internal.detect.DetectResult",
        desc_: "output_0",
      },
    ],
    is_graph_: true,
    ...
    node_repository_: [
      {
        ...
        flag_: "kCodecFlagImage",
        path_:
          "/home/always/github/public/nndeploy/docs/image/demo/detect/sample.jpg",
        size_: 1,
      },
      {
        key_: "YoloPyGraph",
        ...
        node_repository_: [
          ...
          },
          {
            ...
            param_: {
              ...
              is_path_: true,
              model_value_: [
                "/home/always/github/public/nndeploy/build/yolo11s.sim.onnx",
              ],
              input_num_: 0,
              input_name_: [],
              input_shape_: [],
          ...
          },
          {
            ...
            name_: "post",
            desc_:
              "YOLO v5/v6/v7/v8/v11 postprocess[device::Tensor->DetectResult]",
            device_type_: "kDeviceTypeCodeX86:0",
            is_dynamic_input_: false,
            inputs_: [
              {
      ...
      },
      {
        ...
        outputs_: [],
        flag_: "kCodecFlagImage",
        path_: "/home/always/github/public/nndeploy/build/yolo_python_demo.jpg",
        ref_path_: "",
        fourcc_: "mp4v",
        fps_: 0.0,
        width_: 0,
