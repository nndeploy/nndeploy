#ifndef _NNTASK_SOURCE_DETECT_0PENCV_POST_PROCESS_H_
#define _NNTASK_SOURCE_DETECT_0PENCV_POST_PROCESS_H_
...
class DetectPostProcess : public Execution {
 public:
  DetectPostProcess(base::DeviceType device_type, const std::string& name = "")
...
#endif /* _NNTASK_SOURCE_DETECT_0PENCV_POST_PROCESS_H_ */
