 ...
 *
 */
#ifndef _NNDEPLOY_INCLUDE_TASK_NODE_H_
#define _NNDEPLOY_INCLUDE_TASK_NODE_H_
...
class Node {
 public:
  ...
  virtual base::Status setInitConfig(const std::string& key,
                                     const base::Value& value);
  virtual base::Status init();
  virtual base::Status deinit();

  virtual base::Status setPreRunConfig(const Config& config);
  virtual base::Status setPreRunConfig(const std::string& key,
                                       const base::Value& config);
  virtual base::Status preRun();
  virtual base::Status postRun();

  virtual base::Status setRunConfig(const Config& config);
  virtual base::Status setRunConfig(const std::string& key,
                                    const base::Value& config);
