...
/**
  ...
  */
class ZDL_EXPORT UserBufferEncodingFloatN : public UserBufferEncoding {
public:
    UserBufferEncodingFloatN(uint8_t bWidth=32)
      : UserBufferEncoding(getTypeFromWidth(bWidth)), bitWidth(bWidth) {};
    size_t getElementSize() const noexcept override;
...
/**
  ...
  */
class ZDL_EXPORT UserBufferEncodingFloat : public UserBufferEncodingFloatN {
public:
...
/**
  ...
  */
class ZDL_EXPORT UserBufferEncodingIntN : public UserBufferEncoding {
public:
   UserBufferEncodingIntN(uint8_t bWidth=32):
                                           UserBufferEncoding(getTypeFromWidth(bWidth)),
                                           bitWidth(bWidth){};

   UserBufferEncodingIntN(const zdl::DlSystem::UserBufferEncoding &ubEncoding) : UserBufferEncoding(ubEncoding.getElementType()){
            const zdl::DlSystem::UserBufferEncodingIntN* ubEncodingIntN
                            = dynamic_cast <const zdl::DlSystem::UserBufferEncodingIntN*> (&ubEncoding);
            if (ubEncodingIntN) {
                bitWidth = ubEncodingIntN->bitWidth;
            }
   }
   size_t getElementSize() const noexcept override;
   ElementType_t getTypeFromWidth(uint8_t width);
...
/**
  ...
  */
class ZDL_EXPORT UserBufferEncodingUintN : public UserBufferEncoding {
public:
   UserBufferEncodingUintN(uint8_t bWidth=32):
                                           UserBufferEncoding(getTypeFromWidth(bWidth)),
                                           bitWidth(bWidth){};

   UserBufferEncodingUintN(const zdl::DlSystem::UserBufferEncoding &ubEncoding) : UserBufferEncoding(ubEncoding.getElementType()){
            const zdl::DlSystem::UserBufferEncodingUintN* ubEncodingUintN
                            = dynamic_cast <const zdl::DlSystem::UserBufferEncodingUintN*> (&ubEncoding);
            if (ubEncodingUintN) {
                bitWidth = ubEncodingUintN->bitWidth;
            }
   }
   size_t getElementSize() const noexcept override;
   ElementType_t getTypeFromWidth(uint8_t width);
