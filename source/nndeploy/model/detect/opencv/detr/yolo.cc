...
// // static TypeTaskRegister
// g_internal_opencv_detr_task_register("opencv_detr",
// // creatDetrTask);
...
//   YoloPostParam* temp_param = (YoloPostParam*)param_.get();
...
//   pipeline::Task* pre =
//   pipeline->createTask<pipeline::opencv::CvtColrResize>(
