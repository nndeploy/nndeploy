...
base::Status computeNMS(const DetectResults& src,
                        std::vector<int>& keep_idxs,  // 自己建，输入
...
base::Status computeNMS(const DetectResults& src, const float iou_threshold,
                        DetectResults& dst) {
