...
nvinfer1::DataType OnnxRuntimeConvert::convertFromDataType(
    base::DataType &src) {
...
base::DataFormat OnnxRuntimeConvert::convertToDataFormat(
...
base::IntVector OnnxRuntimeConvert::convertToShape(const nvinfer1::Dims &src) {
  base::IntVector dst;
...
nvinfer1::Dims OnnxRuntimeConvert::convertFromShape(
