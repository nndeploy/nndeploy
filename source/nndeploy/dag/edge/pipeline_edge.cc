...
// base::Status PipelineEdge::set(device::Mat *mat, int index, bool
// is_external); base::Status PipelineEdge::set(device::Mat &mat, int index,
// bool is_external); base::Status PipelineEdge::create(device::Device *device,
...
// base::Status PipelineEdge::set(base::Param *param, int index, bool
// is_external); base::Status PipelineEdge::set(base::Param &param, int index,
// bool is_external); virtual base::Param *getParam(const Node *comsumer);
