...
./nndeploy_demo_classification --name nndeploy::classification::ClassificationGraph --inference_type kInferenceTypeOnnxRuntime --device_type kDeviceTypeCodeX86:0 --model_type kModelTypeOnnx --is_path --model_value /home/lds/modelscope/nndeploy/classification/resnet50-v1-7.slim.onnx --codec_flag kCodecFlagImage --parallel_type kParallelTypeTask --input_path ../docs/image/demo/segment/sample.jpg --output_path resnet_ort_arm_sample_output.jpg
