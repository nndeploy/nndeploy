...
//   CHECK(cudaMemcpy(d_decoder_out, h_decoder_out, sizeof(float) * total_size,
//                    cudaMemcpyHostToDevice));
//   CHECK(cudaMemcpy(d_scale, h_scale, sizeof(float) * hidden_units,
//                    cudaMemcpyHostToDevice));
...
//   CHECK(cudaMemcpy(decoder_out, d_decoder_out, sizeof(float) * total_size,
