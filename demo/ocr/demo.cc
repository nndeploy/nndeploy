...
class SuperResolutionDemo : public dag::Graph {
 public:
  ...
  base::Status make(base::InferenceType inference_type, int batch_size) {
    ...
    graph_ =
        (ocr::SuperResolutionGraph *)this
            ->createNode<ocr::SuperResolutionGraph>("resnet");
 ...
 public:
  ...
  ocr::SuperResolutionGraph *graph_;
};
...
int main(int argc, char *argv[]) {
  ...
  // 检测模型的有向无环图graph名称，例如:nndeploy::ocr::SuperResolutionGraph
