...
// NNDEPLOY_API_PYBIND11_MODULE_WITH_DEPS("codec", m, "dag") {
//   // 首先导入dag模块
...
//   // 导出创建节点的函数
//   m.def("create_decode_node", &createDecodeNode, py::arg("type"), py::arg("flag"), py::arg("name"), py::arg("output"));
//   m.def("create_decode_node_shared_ptr", &createDecodeNodeSharedPtr, py::arg("type"), py::arg("flag"), py::arg("name"), py::arg("output"));
//   m.def("create_encode_node", &createEncodeNode, py::arg("type"), py::arg("flag"), py::arg("name"), py::arg("input"));
//   m.def("create_encode_node_shared_ptr", &createEncodeNodeSharedPtr, py::arg("type"), py::arg("flag"), py::arg("name"), py::arg("input"));
// }
